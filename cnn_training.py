...
# 全局变量  
batch_size = 10  # 批处理样本数量
nb_classes = 2  # 分类数目
epochs = 600  # 迭代次数
img_rows, img_cols = 468, 603  # 输入图片样本的宽高
...
X_train=np.array([cap.read()[1][132:600, 191:794] for i in range(50)])

BW = loadmat("project_2_manual_segmentation.mat")['BW']
Y_train=BW[132:600,191:794,0:50]

X_test=np.array([cap.read()[1][132:600, 191:794] for i in range(50)])
Y_test=BW[132:600,191:794,50:100]
